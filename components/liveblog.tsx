...
export function LiveBlogView({ live }: { live: Live }) {
      ...
      <GradientContainer className="md:my-20">
        <Container className="py-20 max-w-5xl mx-auto relative z-40">
          <div className="py-10 text-white">
            ...
            <div className="text-lg leading-relaxed">{live.description}</div>
          </div>
        </Container>
      </GradientContainer>
    );
